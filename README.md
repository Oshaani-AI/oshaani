...
`docker compose build` requires the Buildx plugin **v0.17.0 or later**. Docker Desktop and most recent Docker Engine packages include a compatible version — check yours with:
